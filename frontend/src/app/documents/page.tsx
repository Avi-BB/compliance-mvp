  ...
  return (
    <Box
      sx={{
        ...
        minHeight: "100vh",
        background:
          "linear-gradient(135deg, rgba(37, 99, 235, 0.03) 0%, transparent 50%, rgba(16, 185, 129, 0.03) 100%)",
      }}
    >
          ...
          >
            <Box>
              ...
              <Typography
                ...
                sx={{ maxWidth: 700 }}
              >
                Upload and manage regulatory documents, contracts, and policies
                for AI-powered compliance assessment.
              </Typography>
            </Box>
            <PrimaryButton
              variant="contained"
          ...
          >
            <CardContent sx={{ p: 4 }}>
              <Box sx={{ mb: 2 }}>
                ...
                <Typography variant="body2" color="text.secondary">
                  Manage requirements, obligations, penalties, timelines,
